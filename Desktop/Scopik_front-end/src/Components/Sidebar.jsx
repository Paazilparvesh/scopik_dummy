...
const Sidebar = () => {
  return (
    <div className="bg-[#0A2E6C] h-[720px] transition-all duration-300 group mx-10 my-10 w-20 hover:w-56 flex flex-col items-start py-6 px-4 rounded-2xl overflow-hidden">
